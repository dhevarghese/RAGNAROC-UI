      ...
      <aside className="guide" onClick={(e) => e.stopPropagation()} role="dialog" aria-label="guide">
        ...
        <div className="guide-body">
          <section>
            <h3>Build</h3>
            <ul>
              <li><b>Stimulus types</b> (left panel) are kinds of things — target, distractor. <b>Bottom-up</b> = salience, <b>top-down</b> = task relevance.</li>
              ...
              <li>The <b>schedule</b> shows when each object is on screen. Nothing can appear before 100 ms — the model needs that to settle.</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>The <b>3-D surface</b> shows one map at the current instant — pick which with the chips, drag to orbit. The small maps show everything at once; click one to feature it.</li>
          ...
          <section>
            <h3>Keep</h3>
            <ul>
              <li><b>Share link</b> encodes the whole experiment in the URL — send it to anyone.</li>
